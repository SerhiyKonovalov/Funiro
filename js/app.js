(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__body")) new swiper_core_Swiper(".slider-main__body", {
        ...
        if (document.querySelector(".slider-rooms__body")) new swiper_core_Swiper(".slider-rooms__body", {
        ...
        if (document.querySelector(".slider-tips__body")) new swiper_core_Swiper(".slider-tips__body", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
...
***************************************************************************** */
    ...
    lightgallery_es5(document.querySelector(".furniture__items"), {
    ...
    window.onload = function() {
        ...
        if (furniture && !isMobile.any()) {
            ...
            function setMouseGalleryStyle() {
                ...
                let position = furnitureDifferent / 30 * positionX;
            ...
            furniture.addEventListener("mousemove", (function(e) {
                ...
                const coordX = e.pageX - furnitureWidth / 1.5;
                coordXprocent = coordX / furnitureWidth * 11;
